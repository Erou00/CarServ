<template>
    <div>
      ...
      <fieldset class="form-group p-3 mt-2">
        <legend class="p-2">Détails de convention</legend>
        <div class="form-group row">
          ...
          <div class="col-2">
            <v-select
              ...
              label="no_convention"
              @input="setconventions"
              v-model="bl.convention_id"
            ></v-select>
            <input type="hidden" name="convention_id" :value="bl.convention_id">
          </div>
          ...
          <div class="col-2">
            <div class="input-group">
              <input
                ...
                id="date"
                :value="convention ? convention[0].ods : ''"
              />
            </div>
          </div>
          ...
          <div class="col-3">
            <input
              ...
              placeholder=""
              id="no_convention"
              :value="convention ? convention[0].fournisseur.nom : ''"
            />
          </div>
        </div>
      </fieldset>
        ...
        <div class="form-group row">
          ...
          <div class="col-2">
            <div class="input-group">
                ...
                placeholder=""
                id="date"
                :min="convention ?  convention[0].ods : ''"
                :max="dateNow"
                v-model="bl.date"
                @change="calcule"
                required
...
const mustBeCool = (value, detail) => {
  ...
  export default {
    ...
    computed: {
      conventions(){
          return Object.values(this.$store.getters.conventionsList);
      },
      magasins(){
    ...
    methods: {
      async setconventions(id){
        if (id != null) {
        await this.$store.dispatch("displayAllConventionDetails",id)
        this.opened=[]
        this.stocks =this.$store.getters.conventionDetailsList;
        this.convention =this.$store.getters.conventionById;

        this.bl.fournisseur_id = this.convention[0].fournisseur_id
        this.bl.convention_id = this.convention[0].id
        this.bl.magasin_id = this.convention[0].magasin_id;
        this.bl.sous_magasin_id = this.convention[0].sous_magasin_id;
    ...
    annuler() {},
      ...
      calcule(){
        let date_1 = new Date(this.convention[0].ods);
        console.log(date_1);
        ...
        this.bl.retard =  this.convention[0].delais_execution - days(date_1, date_2)
        if (this.bl.retard >= 0 ) {
    ...
    mounted() {
      this.$store.dispatch("displayAllConventions");
