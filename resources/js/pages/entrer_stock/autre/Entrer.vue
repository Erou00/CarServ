    ...
    <div class="formProduit">
      ...
      <div class="row mb-0">
        ...
        <fieldset class="form-group p-3 mt-2">
                    <legend class="p-2">ENTRÉE</legend>

                    <div class="form-group row">
                        <label for="text1" class="col-2 col-form-label text-end">N° BL:</label>
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" name="no_bl" type="text" required="required"
                                    class="form-control"
                                    v-model="entrer.no_entrer">
                            </div>
                        </div>
                        <label for="text1" class="col-1 col-form-label text-end">Date:</label>
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" name="date" type="date" required="required"
                                    class="form-control" :max="new Date().toISOString().substr(0, 10)">
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <v-select
                                ...
                                label="nom"
                                v-model="entrer.fournisseur_id"
                            ></v-select>

                            <input type="hidden" name="fournisseur_id" :value="entrer.fournisseur_id">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                    <select name="tva" id="" class="form-control" v-model="entrer.tva">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                v-model="entrer.sous_magasin_id" >
                ...
                <fieldset class="form-group p-3 my-3">
                    <legend class="p-2">Bon Entrer Details</legend>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(o, index) in $v.stocks.$each.$iter" :key="index">
                <td scope="row"><input type="text" readonly class="form-control"
                    :name="'entrerDetails['+index+'][produit_id]'" v-model="o.produit_id.$model"
                    ></td>
                ...
                <td>
                  <input
                    type="number"
                    :name="'entrerDetails['+index+'][prix_total]'"
                    id="prix_total"
                    class="form-control"
                    :value="
                      Math.ceil((o.prix_total.$model =
                        o.puht.$model * o.qte.$model * (1 + entrer.tva / 100)))
                    "
                    readonly
                  />
