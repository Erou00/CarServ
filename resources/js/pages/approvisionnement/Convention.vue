<template>
    <div>
        ...
        <fieldset class="form-group p-3 mt-2">
                        <legend class="p-2">Convention</legend>
                        <div class="form-group row">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <input id="text1" name="no_convention" type="text" required="required"
                                        class="form-control"
                                        v-model="convention.no_convention">
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <v-select
                                    ...
                                    label="nom"
                                    v-model="convention.fournisseur_id"
                                ></v-select>

                                <input type="hidden" name="fournisseur_id" :value="convention.fournisseur_id">
                            </div>
                            <label for="text1" class="col-1 col-form-label text-end">TVA %:</label>
                            <div class="col-2">
                                <div class="input-group">
                                    <select name="tva" id="" class="form-control" v-model="convention.tva">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <select name="sous_magasin_id" id="" class="form-control"
                                         v-model="convention.sous_magasin_id" >
                    ...
                    <fieldset class="form-group p-3 my-3">
                        <legend class="p-2">convention Details</legend>
                ...
                <tbody>
                  <tr v-for="(o, index) in $v.stocks.$each.$iter" :key="index">
                    <td scope="row"><input type="text" class="form-control"
                        :name="'conventionDetails['+index+'][produit_id]'"
                    ...
                    <td>
                      <input
                        ...
                        :name="'conventionDetails['+index+'][qte]'"
                      />
                    ...
                    <td>
                      <input
                        type="number"
                        :name="'conventionDetails['+index+'][puht]'"
                        step="0.00001"
                        id="puht"
                        class="form-control"
                    ...
                    <td>
                      <input
                        type="number"
                        step="0.01"
                        :name="'conventionDetails['+index+'][tva]'"
                        id="tva"
                        class="form-control"
                    ...
                    <td>
                      <input
                        type="number"
                        step="0.01"
                        :name="'conventionDetails['+index+'][prix_total]'"
                        id="prix_total"
                        class="form-control"
                        :value="
                          Math.ceil((o.prix_total.$model =
                            o.puht.$model * o.qte.$model * (1 + convention.tva / 100)))
                        "
                        readonly
                      />
              ...
              <div class="row">
                ...
                <div class="col-md-4 d-flex">
                  ...
                  <input
                    ...
                    class="form-control"
                    disabled
                    :value="Math.ceil(stocks.reduce((acc, item) => acc + item.qte, 0))"
                  />
                </div>
                </div>
                <div class="col-md-4 d-flex">
