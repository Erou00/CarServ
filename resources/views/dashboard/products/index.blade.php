                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('dashboard.products.edit',$product->id)}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>

                                <a href="{{route('dashboard.products.show',$product->id)}}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
