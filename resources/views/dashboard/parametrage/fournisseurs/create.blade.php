            ...
            @include('dashboard.partials._errors')
                ...
                {{ method_field('post') }}
                    ...
                    <fieldset class="form-group p-3 mt-2">
                        <legend class="p-2">Ajouter Un Fournisseur</legend>
                ...
                <div class="rendered-form">
                    <div class="formbuilder-select form-group row">
                      ...
                      <div class="col-2">
                        <input type="text" class="form-control" name="nom" access="false" id="nom" required="required" aria-required="true">
                      </div>
                      ...
                      <div class="col-2">
                        <input type="text" class="form-control" name="representant" access="false" id="representant"  aria-required="true">
                      </div>

                      <label for="adresse" class="formbuilder-text-label col-1 text-end">Adresse:<span class="formbuilder-required"></span></label>
                        <div class="col-2">
                            <input type="text" class="form-control" name="adresse" access="false" id="adresse"  aria-required="true">
                        </div>
                    ...
                    <div class="formbuilder-text form-group field-adresse row my-2">
                        ...
                        <div class="col-2">
                             <input type="tel" class="form-control" name="telephone" access="false" id="telephone"  aria-required="true">
                        </div>
                        ...
                        <div class="col-2">
                            <input type="text" class="form-control" name="fax" access="false" id="fax"  aria-required="true">
                        </div>

                        <label for="email" class="formbuilder-text-label col-1 text-end">Email:<span class="formbuilder-required"></span></label>
                        <div class="col-2">
                          <input type="email" class="form-control" name="email" access="false" id="email"  aria-required="true">
                         </div>


                         <label for="siteweb" class="formbuilder-text-label col-1 text-end">Site Web:</label>
                         <div class="col-2">
                             <input type="text" class="form-control" name="siteweb" access="false" id="siteweb">
                         </div>
                    ...
                    <div class="formbuilder-text form-group field-email row">
                        ...
                        <div class="col-2">
                            <input type="text" class="form-control" name="patente" access="false" id="patente">
                        </div>
