            ...
            <div class="box-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            {{-- <form method="post" action="{{route('pays.bulk_delete')}}" style="display: inline-block;">
                                @csrf
                                @method('delete')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table datatable" id="pays-table" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>
...
$(document).ready( function () {
    let genresTable = $('#pays-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
