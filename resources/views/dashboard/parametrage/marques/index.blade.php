            ...
            <div class="box-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="{{route('marques.print')}}" class="btn btn-primary">
                                <i class="fa fa-print"></i>Imprimer
                            </a>
                            {{-- <form method="post" action="{{route('marques.bulk_delete')}}" style="display: inline-block;">
                                @csrf
                                @method('delete')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table datatable" id="marques-table" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>
...
$(document).ready( function () {
    ...
    let marquesTable = $('#marques-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
        ...
        $('#data-table-search').keyup(function() {
            marquesTable.search(this.value).draw();
        })

        $('#categorie').on('change', function () {
            categorie = this.value;
            marquesTable.ajax.reload();
        });
} );
