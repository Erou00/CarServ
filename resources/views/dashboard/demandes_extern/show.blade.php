...
@section('content')
    ...
    <section>
        <div class="container mt-2">
            <form action="{{ route('demandes-externe.update', $demande->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-0">
                                                    ...
                                                    <tbody>
                                                        @foreach ($demande->demandeDetails->sortBy('created_at') as $details)
                                                            <tr>
                                                                ...
                                                                <td>{{ ($details->produit->stock)? $details->produit->stock->qte : 0 }}</td>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body demandeDetailsForm">
                                                                            <form action="{{route('demandes-externe.updateDetails',$details->id)}}" method="post">
                                                                                @csrf
                                                                                @method('PUT')
                                                                ...
                                                                <div class="modal-dialog">
                                                                  <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer delete-form">
                                                                       ...
                                                                       <form action="{{route('demandes-externe.deleteDetails',$details->id)}}" method="post">
                                                                        @csrf
                                                                        @method('DELETE')
