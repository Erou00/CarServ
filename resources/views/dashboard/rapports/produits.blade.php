...
{{--
        ...
        <tbody>
            <tr>
                ...
                <td class="px-0" align="center">
                        ...
                        <h2><Strong>Les Articles {{ $data['active'] }}</Strong></h2>
    ...
    <h2 style="margin-left: 30px">LES ARTICLES {{ $data['active'] }} DE LA CATEGORIE : {{$cat['nom']}}</h2>

    @php ($categories = 0 )
    @foreach ($data['souscategories'] as $scat)
        @if ($scat['categorie_id'] == $cat['id'])
               <h3 style="margin-left: 40px">SOUS CATEGORIE : {{$scat['nom']}}</h3>
               ...
               <table class="table data">
                   <thead>
                       <tr>
                                ...
                                <th scope="col" class="">Prix Unitaire</th>
                                <th scope="col" class="">Stock min</th>
                        </tr>
                   ...
                   <tbody>
                       ...
                       @foreach ($data['details'] as $item)
                          @if ($item['categorie_id'] == $cat['id'] && $item['sous_categorie_id'] == $scat['id'])
                            <tr>
                                <td>{{$item['id']}}</td>
                                <td>{{($item['marque'] ? $item['marque']['nom']:' ')}}</td>
                                <td>{{$item['uniteReglementaire']['code']}}</td>
