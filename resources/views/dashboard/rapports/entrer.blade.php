    ...
    <tbody>
        <tr>
            ...
            <td class="px-0" align="center">
                    ...
                    <h2><Strong>ENTRÉE N°: {{$data['no_entrer']}}</Strong></h2>
      ...
      <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <p class="bs_details">
                       <strong>Date:</strong> {{$data['date_bl']}}
                    </p>
        ...
        <table class="table data">
            ...
            <tbody>
                ...
                @foreach ($data['details']['entrerDetails'] as $item)
                    <tr>
         ...
         {{-- signature --}}
          ...
          <div class="paragraph" style="margin-left: 500px">
            ...
            MONTANT  T.T.C <strong>{{$amount}} Dh</strong>
        </div>
