    ...
    <table class="table mt-1">
        ...
        <tbody>
            <tr>
                <td class="px-0">
                    ...
                    <p class="bs_details">
                       Convention N°: <strong>{{$data['name']}}</strong>
                    </p>

                    <p class="bs_details">
                        Date ODS : <strong>{{\Carbon\Carbon::parse($data['date_convention'])->format('d/m/Y')}}</strong>
                    </p>
     ...
     <table class="table data">
        ...
        <tbody>
            ...
            @foreach ($data['details']['conventionDetails'] as $item)
                <tr>
