    ...
    <table class="table mt-1">
        <tbody>
            <tr>
                ...
                <td class="border-0 pl-0" width="40%" align="center">
                    <h1><strong>Commande Interne <br>
                       <strong>N°: {{$data['name']}}</strong></h1>
                </td>
                <td class="border-0 pl-0 pt-9 mt-9" width="20%">
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tbody>
            <tr>
                <td class="px-0">
                    ...
                    <p class="bs_details">
                        Entite : <strong>{{$data['entite']}}</strong>
                    </p>
     ...
     <table class="table data">
        ...
        <tbody>
            ...
            @foreach ($data['details']['demandeDetails'] as $item)
                <tr>
                   ...
                   <td>{{$item['produit']['prix_unitaire'] * $item['qte_demandee']}}</td>
                </tr>
            @endforeach
     ...
     {{-- signature --}}
      ...
      <div class="signature" style="margin-left:450px">
        ...
        @foreach ($data['details']['demandeDetails'] as $item)
        @php
        $amount += $item['produit']['prix_unitaire'] * $item['qte_demandee']
        @endphp
        @endforeach

       Prix Total : <strong>{{$amount}} Dh</strong>
    </div>
