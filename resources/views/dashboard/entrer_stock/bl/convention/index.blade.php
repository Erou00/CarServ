                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <select class="form-control search-slt convention ms-2"
                                id="exampleFormControlSelect1">
                                <option value="">Choissisez un convention</option>
                                @foreach ($conventions as $c)
                                    <option value="{{$c->id}}">{{$c->no_convention}}</option>
                                @endforeach
                            </select>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            table = $('#bls-table').DataTable({
                ...
                ajax: {
                    url: '{{ route('bls.getBlofConvention') }}',
                    data: function(d) {
                        d.convention_id = $('.convention').val()
                        d.no_bl = $('.no_bl').val()
                        d.date = $('.date').val()
