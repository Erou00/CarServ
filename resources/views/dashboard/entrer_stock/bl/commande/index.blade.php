                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 px-1">
                            <select class="form-control search-slt commande "
                                id="exampleFormControlSelect1">
                                <option value="">Choissisez un commande</option>
                                @foreach ($commandes as $c)
                                    <option value="{{$c->id}}">{{$c->no_commande}}</option>
                                @endforeach
                            </select>
                        </div>
