            ...
            <form action="{{ route('marches.update', $marche->id) }}" method="post">
                ...
                <div class="row mb-0">
                    <div class="col-md-6 offset-md-6 d-lg-flex  justify-content-end">
                        <a href="{{ route('marches.rapport', $marche->id) }}" name="imprimer" value="imprimer"
                ...
                <fieldset class="form-group p-3 mt-2">
                    <legend class="p-2">{{ $marche->no_marche }} :
                        <div>
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" name="no_marche" type="text" required="required"
                                    class="form-control disableClass" disabled value="{{ $marche->no_marche }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <select class="form-control select disableClass" name="fournisseur_id" disabled>
                                ...
                                @foreach ($fournisseurs as $f)
                                    <option value="{{ $f->id }}"
                                        {{ $f->id == $marche->fournisseur_id ? 'selected' : '' }}>
                                        {{ $f->nom }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" name="tva" disabled type="number" required="required"
                                    class="form-control tva disableClass" value="{{ $marche->tva }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" name="ligne_budgetaire" disabled type="text" required="required"
                                    class="form-control disableClass" value="{{ $marche->ligne_budgetaire }}">
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" name="ods" disabled type="text" required="required"
                                    class="form-control disableClass" value="{{ $marche->ods }}">
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input id="text1" disabled name="delais_execution" type="number" required="required" placeholder=""
                                    class="form-control disableClass" value="{{ $marche->delais_execution }}">
                            </div>
                        </div>
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-3">
                            ...
                            disabled>
                                ...
                                @foreach (Auth::user()->sousmagasins as $sm)
                                    <option value="{{ $sm->id }}"
                                        {{ $sm->id == $marche->sous_magasin_id ? 'selected' : '' }}>
                                        {{ $sm->nom}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-5">
                            <textarea id="textarea" disabled name="objet" cols="40" rows="2" class="form-control disableClass">{{ $marche->objet }}</textarea>
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <div class="form-control border-0">
                                    <input type="radio" disabled  {{ $marche->type == 'marche cadre' ? 'checked' : '' }} name="type" id="ch1" class="disableClass" value="marche cadre">
                                    <label for="ch-cadre">Marché cadre</label><br>
                                    <input type="radio" disabled {{ $marche->type == 'marche fermé' ? 'checked' : '' }} name="type" id="ch2" class="disableClass" value="marche fermé">
                                    <label for="ch-ferme">Marché fermé</label>
                                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 offset-lg-8">
                                <label for="" class="mt-2">
                                    ...
                                    {{ $marche->user->nom . ' ' . $marche->user->prenom }}, Le:
                                    <i class="fa fa-calendar"></i> {{ date('d/m/Y', strtotime($marche->created_at)) }}
                                </label>
                            </div>
            ...
            <ul class="nav nav-tabs mt-2" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                        ...
                        <h6><strong>Details de marche</strong></h6>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"
                        role="tab" aria-controls="profile" aria-selected="false">
                        <h6><strong>Historiques de marche</strong></h6>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#bls" type="button"
                        ...
                        <h6><strong>B.L({{ $marche->bls->count() }})</strong></h6>
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table datatable mt-2" id="marches-table"
                                                    style="width: 100%;">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach ($marche->marcheDetails->sortBy('created_at') as $s)
                                                            <tr>
                                                                    ...
                                                                    <div class="modal fade"
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div
                                                                                    class="container marcheDetailsForm">
                                                                                    <form
                                                                                        action="{{ route('marches.updateStock', $s->id) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('PUT')
                                                                                        <update-marche-details-form
                                                                                            :qte="{{ $s->qte }}"
                                                                                            :puht="{{ $s->puht }}"
                                                                                            :tva="{{ $marche->tva }}"
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="modal-footer delete-form">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('marches.deleteStock', $s->id) }}"
                                                                                        method="post">
                                                                                        @csrf
                                                                                        @method('DELETE')
                                                                                        <button type="button"
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    ...
                                    <table class="table datatable" id="historiques-table" style="width: 100%;">
                                        ...
                                        <tbody>
                                            @foreach ($marche->historiquemarches->sortBy('created_at') as $hc)
                                                <tr>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    ...
                                    <table class="table datatable" id="bls-table" style="width: 100%;">
                                        ...
                                        <tbody>
                                            @foreach ($marche->bls->sortBy('created_at') as $bl)
                                                <tr>
                                                    <td>{{ $bl->no_bl }}</td>
                ...
                <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <add-marche-details-form    :mid="{{$marche->id}}" :tva="{{$marche->tva}}" />
                        </div>
                        <div class="modal-footer">
