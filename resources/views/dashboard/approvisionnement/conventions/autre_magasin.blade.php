                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                            <input type="text" class="form-control search-slt no_convention"
...
<section class=" mt-3" id="app">
    ...
    <div class="container">
        ...
        <table class="table datatable" id="conventions-table" style="width: 100%;">
            <thead>
                <tr>
                    <th></th>
                    <th>N° Convention</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            table = $('#conventions-table').DataTable({
                ...
                processing: true,
                ajax: {
                    url: '{{ route('conventions.autre_magasins') }}',
                    data: function(d) {
                        d.no_convention = $('.no_convention').val()
                        d.objet = $('.objet').val()
                        d.date = $('.date').val()
            ...
            $('#conventions-table tbody').on('click', 'td.dt-control', function () {
                ...
                if (row.child.isShown()) {
                    ...
                    // Open this row
                    row.child(row.data().convention_details).show();
                    tr.addClass('shown');
                }
            });

            $(".no_convention").keyup(function() {
                table.draw();
            });
