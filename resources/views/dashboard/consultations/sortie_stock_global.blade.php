    ...
    <section class="content">
        <section class="content">
            ...
            <fieldset class="form-group p-3 mt-2">
                <legend class="p-2">Sortie Stock GLOBAL</legend>

                <form action="{{ route('consultations.sortieStocksGlobalFilter') }}" method="get">
                    @csrf
                    <div class="container-fluid mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-4">
                                <select name="sous_magasin_id" class="form-control sous_magasin_id"
                                id="sous_magasin_id">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/vue/2.6.11/vue.min.js"></script>
        ...
        <script>
            $(document).ready(function() {
                ...
                table = $('#stock-table').DataTable({
                    ...
                    buttons: [
                        ...
                        {
                        extend: 'excel',
                        title: 'Sortie Stock Global '+' ' +new Date().toLocaleString(),
                        exportOptions: {
                            modifier : {
                                    order : "index",
                                    page : "all",
                ...
                "url": "{{ asset('assets/datatable-lang/fr.json') }}"
                    ...
                    processing: true,
                    ajax: {
                        url: '{{ route('consultations.sortieStocksGlobalFilter') }}',
                        data: function(d) {
                            ...
                            d.sous_magasin_id = $('.sous_magasin_id').val()
                        }
                    },
                    columns: [
            ...
            $(".sous_categorie_id").on('change',function() {
                ...
                $(".sous_magasin_id").on('change',function() {
                    table.draw();
                });
