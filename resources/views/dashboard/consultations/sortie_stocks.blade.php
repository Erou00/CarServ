    ...
    <section class="content">
        <section class="content">
            ...
            <fieldset class="form-group p-3 mt-2">
                ...
                <form action="{{ route('consultations.sortieStocksFilter') }}" method="get">
                    @csrf
                    <div class="container-fluid mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-4">
                                <select class="form-control entite_id select" name="entite_id" id="">
                            ...
                            <div class="col-md-3 mt-4">
                                <select class="form-control entite_mere_id select" name="entite_mere_id" id="">
                                    <option value="">Entite Mere</option>
                                    @foreach ($entitesMere as $em)
                                        <option value="{{ $em->id }}">{{ $em->nom }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3 mt-4">
                                <select class="form-control magasin_id select"
                                 name="magasin_id" id="" data-dependent="sous_magasin_id">
                            ...
                            <div class="col-md-3 mt-4">
                                <select class="form-control bl_id select" name="bl_id" id="">
                                    <option value="">N° BL</option>
                                    @foreach ($bs as $b)
                                        <option value="{{ $b->id }}">{{ $b->no_bl.'/'.$b->annee }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mt-1">
                                ...
                                <div class="d-flex">
                                    <input type="date" class="form-control startDate" id="" placeholder=""
                                        name="startDate">
                                    <input type="date" class="form-control endDate mx-1" id="" placeholder=""
                                        name="endDate">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mt-4">
                                <select class="form-control" name="trier" id="">
                                    <option value="">Type des états</option>
                                    <option value="annee">Par Annee</option>
                                    <option value="entitee">Par Entitee</option>
                                    <option value="entite_mere">Par Entitee Mere</option>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/vue/2.6.11/vue.min.js"></script>
        ...
        <script>
            $(document).ready(function() {
                ...
                table = $('#stock-table').DataTable({
                    ...
                    buttons: [
                        ...
                        {
                        extend: 'excel',
                        title: 'Sortie Stock MultiCritere '+' ' +new Date().toLocaleString(),
                        exportOptions: {
                            modifier : {
                                    order : "index",
                                    page : "all",
                    ...
                    processing: true,
                    ajax: {
                        url: '{{ route('consultations.sortieStocksFilter') }}',
                        data: function(d) {
                            ...
                            d.entite_id = $('.entite_id').val()
                            d.entite_mere_id= $('.entite_mere_id').val()
                            d.no_bl = $('.no_bl').val()
                            d.demande_id = $('.demande_id').val()
                            d.bl_id = $('.bl_id').val()
            ...
            $(".sous_categorie_id").on('change',function() {
                ...
                $(".bl_id").on('change',function() {
                    table.draw();
                });
                $(".entite_id").on('change',function() {
                    table.draw();
                });
                $(".entite_mere_id").on('change',function() {
                    table.draw();
                });
                ...
                $(".marche_id").on('change',function() {
                    table.draw();
                });
                $(".convention_id").on('change',function() {
                    table.draw();
                });
